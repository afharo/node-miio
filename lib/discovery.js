...
const {  TimedServiceDiscovery,  BasicServiceDiscovery } = require('tinkerhub-discovery');
...
const Browser = (module.exports.Browser = class Browser extends TimedServiceDiscovery {
	static get type() {
		return 'miio';
	}
